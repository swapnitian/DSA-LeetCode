<h2><a href="https://leetcode.com/problems/minimum-energy-to-maintain-brightness">Minimum Energy to Maintain Brightness</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer <code>n</code>, representing <code>n</code> light bulbs arranged in a line and indexed from 0 to <code>n - 1</code>.</p>
